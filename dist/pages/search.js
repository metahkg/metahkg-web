...
import { useCat, useData, useId, useMenu, useRecall, useSearch, useSelected, useMenuTitle, } from "../components/MenuProvider";
...
export default function Search() {
    ...
    useEffect(() => {
        if (querystring.q)
            setQuery(decodeURIComponent(String(querystring.q)));
    ...
    return (_jsx(Box, Object.assign({ className: "flex min-height-fullvh", sx: {
