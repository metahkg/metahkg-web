      ...
      <Box sx={{ width: small ? "100vw" : "50vw" }}>
        <div className="m50">
          <div className="flex justify-center align-center">
            ...
            <h1 className="font-size-25 mb20 nohmargin">Resend Email</h1>
          </div>
          {alert.text && (
          ...
          <div
            className={`${
              small ? "" : "flex fullwidth align-center justify-space-between"
            } mt20`}
          >
            <ReCAPTCHA
              theme="dark"
            ...
            <Button
              ...
              onClick={resend}
              disabled={
                disabled || !(email && rtoken && EmailValidator.validate(email))
              }
            >
