        ...
        <Box sx={sx} className={className}>
            <Editor
                ...
                init={{
                    ...
                    skin_url:
                        "https://cdn.jsdelivr.net/npm/metahkg-css@1.0.4/dist/tinymce/skins/ui/metahkg-dark",
                    content_css:
                        "https://cdn.jsdelivr.net/npm/metahkg-css@1.0.4/dist/tinymce/skins/content/metahkg-dark/content.min.css",
                    branding: false,
                    mobile: {
