 ...
 * @param {MouseEventHandler<HTMLButtonElement>} props.refresh event handler when refresh is clicked
 * @param {number} props.selected selected tab number
 * @param {(e: number) => void} props.onClick event handler when a tab is selected
 */
